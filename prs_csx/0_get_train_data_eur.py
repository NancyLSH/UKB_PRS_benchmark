...
def process_single_file(file_path, output_file):
    if file_path.endswith('.glm.linear'):
        # 读取文件
        if "BETA" not in pd.read_csv(file_path, sep='\t', nrows=0).columns:
...
if __name__ == "__main__":
    gwas_dir = "/data1/jiapl_group/lishuhua/project/PRS_benchmark/real_data/UKB/merged_gwas/White_British/gwas/"
    output_dir = "/data1/jiapl_group/lishuhua/project/PRS_benchmark/software/prscsx/train/EUR/"
