...
# 定义您的GWAS结果文件存放的目录
GWAS_DIR="/data1/jiapl_group/lishuhua/project/PRS_benchmark/real_data/UKB/gwas/White_British"

# 定义合并后文件的输出目录
OUTPUT_DIR="/data1/jiapl_group/lishuhua/project/PRS_benchmark/real_data/UKB/merged_gwas/White_British/gwas/"
...
FILE_SUFFIX="_chr" # 性状名和染色体编号之间的部分
